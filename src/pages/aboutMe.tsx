...
export default function AboutMe() {
  ...
  return (
    <>
      <HeaderGlobal />
      <main
        className="min-h-screen pt-10 px-4 sm:px-6 lg:px-8 pb-20"
      ...
      >
        <div className="relative">
          ...
          <div className="max-w-6xl mx-auto">
            <section
              id="gbr"
              className="mb-16 scroll-mt-24 bg-opacity-5 bg-white p-8 rounded-lg shadow-sm"
            >
            ...
            <section className="mb-16">
              ...
              <div className="mt-6 bg-opacity-5 bg-white p-8 rounded-lg shadow-sm mb-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                  <div className="bg-opacity-10 bg-white p-4 rounded-md hover:shadow-md transition-all">
              ...
              <div className="mt-6 bg-opacity-5 bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="mt-10 bg-opacity-5 bg-white p-8 rounded-lg shadow-sm">
            ...
            >
              <Link
                ...
                className="flex items-center gap-3 opacity-75 hover:opacity-100 transition-opacity p-4 rounded-lg hover:bg-opacity-10 hover:bg-white"
              >
