...
"devDependencies": {
    ...
    "tailwindcss": "^3.4.3"
            ...
            <div className="p-8 max-lg:px-0 col-span-2 col-start-4 row-span-full max-2xl:col-span-3">
              ...
              <p className="pb-8 border-b border-gray-100 border-opacity-10">
                StringBox uses MongoDB as its primary database, managed with
                Mongoose. MongoDB provides a flexible, scalable, and
                high-performance data storage solution. The combination of
                MongoDB and Mongoose ensures efficient data modeling, schema
                validation, and seamless integration with the application.
              </p>
              ...
              <div className="pt-8 pb-8 mb-8">
                <div className="flex row h-16 flex-wrap">
                  ...
                  />
                  <Image
                    src="/images/icons/next-auth.webp"
                    alt="NextAuth.js"
                    width={50}
                    height={50}
                    className="my-2 ml-2"
