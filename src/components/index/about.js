...
function About() {
    return (
        <section id="about" className="bg-gray-100 text-gray-900 flex justify-center items-center min-h-screen px-4 py-12 z-10">
            <div className="max-w-2xl">
                <h2 className="text-4xl mb-8 font-semibold text-gray-900">About</h2>
