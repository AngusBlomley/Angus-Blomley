      ...
      <div className="container mx-auto px-4 pt-8">
        ...
        <div className="max-w-4xl mx-auto mb-8 space-y-8 font-karla">
          <section>
            ...
            <p>
              ...
              Doors field engineers using Expo SDK 54 with native modules. The
              app enables efficient on-site assessments of custom windows and
              doors, featuring robust offline capabilities, data
              synchronization, and enterprise-level state management to
              streamline workflows and replace paper-based processes.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Working as part of the development team, my key contributions
              include:
            </p>
            <ul className="list-disc list-inside space-y-1 mt-2">
              <li>
                Replaced manual paper forms with digital workflows, reducing
                admin time for engineers
              </li>
              <li>
                Implemented offline-first architecture allowing engineers to
                work in areas with poor connectivity
              </li>
              <li>
                Built a queue-based sync system ensuring no data loss between
                field and office
              </li>
              <li>
                Integrated camera and signature capture for on-site
                documentation
              </li>
            </ul>
          </section>
        ...
        <div className="max-w-4xl mx-auto space-y-8 font-karla">
          <section>
            ...
            <p className="mb-4">
              Built with React Native and Expo SDK 54, this application
              demonstrates mobile development expertise with a focus on
              offline-first architecture and reliable state management. The
              project includes queue-based data synchronization, native module
              integration, and error tracking via Sentry.
            </p>
            ...
            <ul className="list-disc list-inside space-y-1 mb-4">
              ...
              <li>
                <strong>Styling:</strong> NativeWind (Tailwind for RN)
              </li>
            </ul>
