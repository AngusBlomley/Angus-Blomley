...
import WorldMap from "@/components/aboutMe/WorldMap";
...
export default function AboutMe() {
  ...
  return (
    <main className="min-h-screen pt-10 px-4 sm:px-6 lg:px-8 pb-20 bg-theme-bg-light dark:bg-theme-bg-dark text-theme-text-light dark:text-theme-text-dark">
